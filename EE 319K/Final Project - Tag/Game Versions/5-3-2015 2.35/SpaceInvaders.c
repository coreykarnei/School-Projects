...
void Master_Funk(void){
	...
	Character_CollisionStatus(player);				// Write collision status for P1
	
	ST7735_SetCursor(16, 1);
	LCD_OutDec(player.hp/5);
	ST7735_SetCursor(16, 2);
	if(player.potato)
		ST7735_OutString("It!");
	else
		ST7735_OutString("Nope");
	
	if(player.hp==0){											// death screen
		ST7735_FillScreen(0x0000);            // set screen to black
		ST7735_SetCursor(1, 1);
		ST7735_OutString("GAME OVER");
		ST7735_SetCursor(1, 2);
